import { pauseTracking, resumeTracking, isRef, toRaw, isReactive, readonlyProps, unlock, lock, effect, stop, reactive, computed as computed$1 } from '@vue/reactivity';
...
function logError(err, type, contextVNode) {
    ...
    if ((process.env.NODE_ENV !== 'production') && (forceRecover || !(process.env.NODE_ENV === 'test'))) {
...
function renderComponentRoot(instance) {
    ...
    try {
        if (vnode.shapeFlag & 4 /* STATEFUL_COMPONENT */) {
            ...
            const propsToPass = (process.env.NODE_ENV !== 'production') ? readonlyProps(props) : props;
