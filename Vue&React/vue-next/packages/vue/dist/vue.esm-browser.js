...
function createRenderer(options) {
    ...
    function unmount(vnode, parentComponent, parentSuspense, doRemove) {
        const { el, props, ref, type, children, dynamicChildren, shapeFlag, anchor, transition } = vnode;
        // unset ref
...
const BaseTransitionImpl = {
    ...
    setup(props, { slots }) {
        ...
        const callTransitionHook = (hook, args) => {
            hook &&
        ...
        return () => {
            ...
            const enterHooks = (innerChild.transition = resolveTransitionHooks(innerChild, rawProps, state, callTransitionHook));
            ...
            if (oldInnerChild &&
                ...
                const leavingHooks = resolveTransitionHooks(oldInnerChild, rawProps, state, callTransitionHook);
...
function resolveTransitionHooks(vnode, { appear, persisted = false, onBeforeEnter, onEnter, onAfterEnter, onEnterCancelled, onBeforeLeave, onLeave, onAfterLeave, onLeaveCancelled }, state, callHook) {
